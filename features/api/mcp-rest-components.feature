...
Feature: C-mcp REST Components
  ...
  Scenario: GET /api/projects/:id/components returns array
    ...
    When I GET "/api/projects/comp-proj/components" with bearer token "test-secret-123"
  ...
  Scenario: GET /api/projects/:id/components/:componentId returns component
    ...
    When I GET "/api/projects/comp-proj2/components/btn" with bearer token "test-secret-123"
    Then the response status is 200
  ...
  Scenario: GET /api/projects/:id/components/nonexistent returns 404
    ...
    When I GET "/api/projects/comp-proj3/components/ghost-component" with bearer token "test-secret-123"
